...
class EnhancedABRTrainer:
    ...
    def _compute_v_prediction_target(self, x_start: torch.Tensor, noise: torch.Tensor, timesteps: torch.Tensor) -> torch.Tensor:
        ...
        sqrt_alpha_cumprod = self.noise_schedule.sqrt_alphas_cumprod[timesteps].view(-1, 1, 1)
        sqrt_one_minus_alpha_cumprod = self.noise_schedule.sqrt_one_minus_alphas_cumprod[timesteps].view(-1, 1, 1)
